...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Liste étudiants insolvables
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Nom(s)/Contact</th><th>Scolarité</th><th>Montant-restant</th><th>Filière</th><th>Date inscription</th><th>Action(s)</th></tr></thead><tbody></tbody></table>');
