...
$aColumns = array( 's.id','s.sname','s.balance','s.fees','b.branch','s.contact','s.joindate');
	...
	while ( $aRow = $rResult->fetch_assoc()  )
	{
		...
		$row = array(
					...
					html_entity_decode('<button class="btn btn-warning btn-xs" onclick="javascript:GetFeeForm('.$aRow['id'].')"><i class="fa fa-usd "></i> Nouveau versement </button>')
...
$aColumns = array( 's.id','s.sname','s.balance','s.fees','b.branch','s.contact','s.joindate');
	...
	while ( $aRow = $rResult->fetch_assoc()  )
	{
		...
		$row = array(
					...
					html_entity_decode('<button class="btn btn-warning btn-xs" onclick="javascript:GetFeeForm('.$aRow['id'].')"><i class="fa fa-usd "></i> Récapitulatif Paiement </button>')
