...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Modificaton des paramètres de connexion</h1>
...
?>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Confirm">Confirmation Mot de passe</label>
								<div class="col-sm-5">
			...
			$( "#signupForm1" ).validate( {
				...
				messages: {
					...
					newpassword: {
						...
						minlength: "Votre mot de passe doit avoir au moins 6 caractères"
					},
					confirmpassword: {
						required: "Ce champ est obligatoire",
						minlength: "Votre mot de passe doit avoir au moins 6 caractères",
